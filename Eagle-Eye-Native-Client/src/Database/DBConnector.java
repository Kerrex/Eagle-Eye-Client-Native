...
public class DBConnector {
    ...
    private DBConnector() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Nie można nawiązać połączenia z bazą danych. Sprawdź konfigurację i połączenie z internetem, a następnie spróbuj ponownie");
        }
    }
    ...
    public ResultSet getBoughtProducts(java.util.Date dateFrom, java.util.Date dateTo, String customerIds) throws SQLException {
        ...
        PreparedStatement ps = con.prepareStatement("SELECT EAN, Sum(Ilosc) FROM eagleeye.KlientProdukt WHERE idKlient IN (" + customerIds + ") AND Data BETWEEN ? AND ? GROUP BY EAN;");
